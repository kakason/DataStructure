...
editor contains an empty string, S. You must perform Q operations of the following
4 types:
...
performed. Each operation starts with a single integer, t (where t belongs to
{1,2,3,4}), denoting a type of operation as defined in the Problem Statement
above. If the operation requires an argument, t is followed by its space-separated
